                ...
                <div className="container about_us">
                    <div className="jumbotron">
                        <div className="container">
                            ...
                            <p> Journeyer strongly believes and follows the concept of Kaizen i.e."change for the better”. It
                                refers
                                to
                ...
                <div className="container about_text">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            ...
                            <h2>Mission</h2>
                            <p className="justify">"Journeyer is passionately committed to Total Quality Travel, with continual delivery of value added
